...
void create_input_histos_RPV(int stage){
  ...
  if (stage==0) {
    fit_resolution->SetParameter(0,0.02);
    fit_resolution->SetParameter(1,1.0e-05);  
    fit_resolution->SetParameter(2,-3.0e-09);
    fit_resolution->SetParameter(3,3.0e-13);   
     
    fit_resolution_up->SetParameter(0,0.03);
    fit_resolution_up->SetParameter(1,1.0e-05);
    fit_resolution_up->SetParameter(2,-2.0e-09);
    fit_resolution_up->SetParameter(3,3.0e-13);
    
    fit_resolution_down->SetParameter(0,0.009);
    fit_resolution_down->SetParameter(1,1.0e-05);
    fit_resolution_down->SetParameter(2,-3.0e-09);
    fit_resolution_down->SetParameter(3,3.0e-13);
  }

  if (stage==1) {
    fit_resolution->SetParameter(0,0.01);
    fit_resolution->SetParameter(1,1.0e-05);  
    fit_resolution->SetParameter(2,-3.0e-09);
    fit_resolution->SetParameter(3,3.0e-13);   
    
    fit_resolution_up->SetParameter(0,0.02);
    fit_resolution_up->SetParameter(1,9.0e-06);
    fit_resolution_up->SetParameter(2,-2.0e-09);
    fit_resolution_up->SetParameter(3,2.0e-13);
    
    fit_resolution_down->SetParameter(0,-0.0002);
    fit_resolution_down->SetParameter(1,2.0e-05);
    fit_resolution_down->SetParameter(2,-4.0e-09);
    fit_resolution_down->SetParameter(3,4.0e-13);
  }

  if (stage==2) {
    fit_resolution->SetParameter(0,0.02);
    fit_resolution->SetParameter(1,2.0e-05);  
    fit_resolution->SetParameter(2,-5.0e-09);
    fit_resolution->SetParameter(3,4.0e-13);   
    
    fit_resolution_up->SetParameter(0,0.03);
    fit_resolution_up->SetParameter(1,2.0e-05);
    fit_resolution_up->SetParameter(2,-5.0e-09);
    fit_resolution_up->SetParameter(3,4.0e-13);
    
    fit_resolution_down->SetParameter(0,0.01);
    fit_resolution_down->SetParameter(1,2.0e-05);
    fit_resolution_down->SetParameter(2,-5.0e-09);
    fit_resolution_down->SetParameter(3,4.0e-13);
  }

  if (stage==3) {
    fit_resolution->SetParameter(0,0.02);
    fit_resolution->SetParameter(1,9.0e-06);  
    fit_resolution->SetParameter(2,-2.0e-09);
    fit_resolution->SetParameter(3,1.0e-13);   
    
    fit_resolution_up->SetParameter(0,0.03);
    fit_resolution_up->SetParameter(1,8.0e-06);
    fit_resolution_up->SetParameter(2,-3.0e-09);
    fit_resolution_up->SetParameter(3,5.0e-13);
    
    fit_resolution_down->SetParameter(0,0.004);
    fit_resolution_down->SetParameter(1,9.0e-06);
    fit_resolution_down->SetParameter(2,-6.0e-10);
    fit_resolution_down->SetParameter(3,-2.0e-13);
  }

  if (stage==4) {
    fit_resolution->SetParameter(0,0.03);
    fit_resolution->SetParameter(1,-3.0e-06);  
    fit_resolution->SetParameter(2,3.0e-09);
    fit_resolution->SetParameter(3,-2.0e-13);   
    
    fit_resolution_up->SetParameter(0,0.04);
    fit_resolution_up->SetParameter(1,-3.0e-06);
    fit_resolution_up->SetParameter(2,2.0e-09);
    fit_resolution_up->SetParameter(3,-2.0e-13);
    
    fit_resolution_down->SetParameter(0,0.02);
    fit_resolution_down->SetParameter(1,-3.0e-06);
    fit_resolution_down->SetParameter(2,3.0e-09);
    fit_resolution_down->SetParameter(3,-2.0e-13);
  }
  ...
  */
  ...
  TF1* gauss = new TF1("gauss","TMath::Gaus(x,[0],[1])",0,10000);
  //  TF1* crystal = new TF1("crystal","ROOT::Math::crystalball_function(x,[0],[1])",mass_sig-8*resolution,mass_sig+8*resolution);
  //  auto f3 = new TF1("f3","ROOT::Math::crystalball_function(x, 2, 2, 1, 0)",-5,5);

  TF1* fit_acceff=new TF1("fit_acceff","[0]+[1]/(x**[2] + [3])+[4]*x",200.,10000.);
  TF1* fit_acceff_2=new TF1("fit_acceff_2","[0]+[1]/(x**[2] + [3])+[4]*x + [5]*exp(-((x-[6])**2)/2*[7]**2)",200.,10000.);
  ...
  for(int k=0;k<num_samples;k++)
    {
      ...
      //      TH1D* signal_temp;
      sprintf(file_title,"root_out/out_mass_%i_Stage%i.root",mass_sig, stage);
      sprintf(dir_title,"txt_out/normalization_Mass_%i_Stage%i_input_histos.txt",mass_sig, stage);
	...
	delete h1;
      ...
      signal_temp=new TH1D("signal_temp","",10000,0.,10000.); 	  
      ...
      for(int m=(bin_limit_upper+1);m<6000;m++)
	{
      ...
      */
      ...
      gauss->SetParameter(0,mass_sig);
      gauss->SetParameter(1,resolution);
      signal_temp_Eff_up=new TH1D("signal_Eff_systUp","",10000,0.,10000.);
      ...
      signal_temp_massRes_up=new TH1D("signal_massRes_systUp","",10000,0.,10000.);
      ...
      signal_temp_massRes_down=new TH1D("signal_massRes_systDown","",10000,0.,10000.);
